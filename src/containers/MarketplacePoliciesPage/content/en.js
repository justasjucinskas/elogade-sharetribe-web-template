// Marketplace Policies — English (source of truth).
//
...
At ELOGADE, your safety comes first. We operate across the Baltic region and selected EU countries. Every eligible purchase is protected by our secure payment process powered by Stripe. Your payment is held safely until you confirm that the item has been received and matches the description. Refunds are handled in accordance with the [Refunds & Payment Reversals](#section-6) section below.

### 1.1 - How Buyer Protection Works

1. Pay securely — your payment is securely held via Stripe until order completion.
2. Seller ships the item within the stated handling time.
3. 48-hour inspection period after the carrier marks the order as delivered.
4. Funds are released to the seller after the buyer protection process is completed. Standard payment processing times may apply.

### 1.2 - 48-Hour Inspection Window
...
* If additional assistance is needed, the buyer may contact ELOGADE support at [support@elogade.com](mailto:support@elogade.com).

### 1.3 - When You Can Report an Issue
...
### 1.4 - Return Shipping Responsibility
...
### 1.5 - Shipping and Carrier Delays
...
### 1.7 - Misuse of Buyer Protection
...
### 1.10 - If the Seller Fails to Ship
...
### 1.11 - Automatic Transaction Completion
...
### 1.12 - Evidence and Review Standard
...
## 2 - Seller Guidelines (Listing Rules)
...
### 2.2 - Prohibited Seller Practices
...
### 2.4 - Trust & Safety (How We Protect Users)
...
1. Browse and purchase safely
2. Pay securely via Stripe
3. Inspect within 48 hours
4. Order is completed automatically after the inspection period

### 3.2 - For Sellers

1. List your device
2. Ship the item
3. Get paid after the buyer protection process is completed according to the platform’s payment schedule
...
* The issue falls under [What Is Not Covered](#section-1-6)
* The buyer has altered, damaged, or misused the item after delivery

### 6.5 - Fee Refund Rules
